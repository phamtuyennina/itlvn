...
@define ('_cohoinghenghiep','Cơ hội nghê nghiệp');
@define ('_giaiphapkinhdoanh','Giải pháp kinh doanh');
@define ('_khuvuc','Khu vực');
@define ('_khachhang','Khách hàng');
@define ('_tintuctruyenthong','Tin tức & truyền thông');
...
@define ('_yeucaudichvu','Yêu cầu dịch vụ');
@define ('_tracuuvandon','Tra cứu vận đơn');
@define ('_huongdanvahoidap','Hướng dẫn & Hỏi đáp');
@define ('_phanhoikhachhang','Phản hổi khách hàng');
@define ('_mangluoikhuvuc','Mạng lưới khu vực');
@define ('_tracuuvandon','Tra cứu vận đơn');
@define ('_huongdanhoidap','Hướng dẫn & hỏi đáp');
@define ('_phanhoikhachhang','Phản hồi khách hàng');
@define ('_luachondichvu','Lựa chọn dịch vụ');
@define ('_diachiemal','Địa chỉ Email');
